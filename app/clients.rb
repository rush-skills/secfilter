...
calls = [
  ...
  "curl -A \"#{ua1}\" -e \"http://badsite.com\" #{web1}/asd.html",
  "curl -A \"#{ua1}\" -e \"http://badsite.com\" #{web2}/asd.html",
  ...
  "curl #{web1}/asd.html",
  "curl #{web2}/asd.html",
  "curl -e \"http://badsite.com\" #{web1}/index.html",
  "curl -e \"http://badsite.com\" #{web2}/index.html",
  "curl -e \"http://badsite.com\" #{web1}/asd.html",
